...
import { getEventsQualificationForAdminByCatégorie } from "../../../../../_redux/actions/events";
...
export default function Events() {
  ...
  useEffect(() => {
    dispatch(getEventsQualificationForAdminByCatégorie(params.id as string));
  }, [dispatch, params.id]);

  const handleClick = (eventId: string) => {
    navigate(`/draw/categories/qualification/${eventId}`);
  };
