...
export default function GameMobile() {
  ...
  const { groupesMatchs, match } = useAppSelector((state) => state.matchsSlice);
                  ...
                  >
                    ...
                    <Grid xs={6} sx={{ textAlign: "right" }}>
                      <img
                        ...
                        src={(process.env.REACT_APP_UPLOADS_LOGO+ match.equipes[0].images) as any}
                  ...
                  >
                    ...
                    <Grid xs={6} sx={{ textAlign: "right" }}>
                      <img
                        ...
                        src={(process.env.REACT_APP_UPLOADS_LOGO+ match.equipes[1].images) as any}
