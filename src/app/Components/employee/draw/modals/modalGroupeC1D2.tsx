...
const ModalGroupeC1D2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["C1"])
    );

  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["C1"]);

  const DrawB2 =
    draw &&
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["D2"])
    );

  const equipe2 =
    DrawB2 && DrawB2.order.find((data) => +data.equipe_id === +draw["D2"]);
...
export default ModalGroupeC1D2;
