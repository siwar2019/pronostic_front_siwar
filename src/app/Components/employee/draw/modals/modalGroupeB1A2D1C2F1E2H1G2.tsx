...
const ModalGroupeB1A2D1C2F1E2H1G2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["B1A2D1C2"])
    );

  const equipe1 =
    DrawA1 &&
    DrawA1.order.find((data) => +data.equipe_id === +draw["B1A2D1C2"]);

  const DrawB2 =
    draw &&
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["F1E2H1G2"])
    );

  const equipe2 =
    DrawB2 &&
    DrawB2.order.find((data) => +data.equipe_id === +draw["F1E2H1G2"]);
...
export default ModalGroupeB1A2D1C2F1E2H1G2;
