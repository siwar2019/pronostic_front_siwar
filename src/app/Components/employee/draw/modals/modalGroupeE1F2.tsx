...
const ModalGroupeE1F2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["E1"])
    );

  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["E1"]);

  const DrawB2 =
    draw &&
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["F2"])
    );

  const equipe2 =
    DrawB2 && DrawB2.order.find((data) => +data.equipe_id === +draw["F2"]);
...
export default ModalGroupeE1F2;
