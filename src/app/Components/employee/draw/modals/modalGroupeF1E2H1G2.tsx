...
const ModalGroupeF1E2H1G2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["F1E2"])
    );

  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["F1E2"]);

  const DrawB2 =
    draw &&
    GroupeEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["H1G2"])
    );

  const equipe2 =
    DrawB2 && DrawB2.order.find((data) => +data.equipe_id === +draw["H1G2"]);
...
export default ModalGroupeF1E2H1G2;
