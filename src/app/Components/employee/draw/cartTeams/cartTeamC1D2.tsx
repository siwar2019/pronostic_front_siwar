...
const CartTeamC1D2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupesEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["C1D2"])
    );
  ...
  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["C1D2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw.C1D2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.C1D2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.C1D2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
