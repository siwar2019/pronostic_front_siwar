  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw &&
        correctDraw.A1B2C1D2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.A1B2C1D2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.A1B2C1D2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
...
export default CartTeamA1B2C1D2;
