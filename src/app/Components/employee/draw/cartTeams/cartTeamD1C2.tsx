...
const CartTeamD1C2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupesEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["D1C2"])
    );
  ...
  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["D1C2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw.D1C2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.D1C2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.D1C2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
