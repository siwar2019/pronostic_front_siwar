...
const CartTeamG1H2 = (props) => {
  ...
  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["G1H2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw.G1H2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.G1H2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.G1H2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
