...
const CartTeamA1B2C1D2E1F2G1H2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupesEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["A1B2C1D2E1F2G1H2"])
    );
  ...
  const equipe1 =
    DrawA1 &&
    DrawA1.order.find((data) => +data.equipe_id === +draw["A1B2C1D2E1F2G1H2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw &&
        correctDraw.A1B2C1D2E1F2G1H2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.A1B2C1D2E1F2G1H2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.A1B2C1D2E1F2G1H2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
...
export default CartTeamA1B2C1D2E1F2G1H2;
