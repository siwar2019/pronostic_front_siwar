...
const CartTeamB1A2D1C2F1E2H1G2 = (props) => {
  ...
  const DrawA1 =
    ...
    GroupesEquipe.find((el) =>
      el.order.find((data) => +data.equipe_id === +draw["B1A2D1C2F1E2H1G2"])
    );
  ...
  const equipe1 =
    DrawA1 &&
    DrawA1.order.find((data) => +data.equipe_id === +draw["B1A2D1C2F1E2H1G2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw &&
        correctDraw.B1A2D1C2F1E2H1G2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.B1A2D1C2F1E2H1G2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.B1A2D1C2F1E2H1G2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
            +correctDraw[roundData[groupIndex]] ? (
              ...
              >
                {drawSetting32TeamEmployee.correctPhase4} points
              </span>
            ) : +draw[roundData[groupIndex]] ===
              +correctDraw[roundDataTwo[groupIndex]] ? (
              <span
...
export default CartTeamB1A2D1C2F1E2H1G2;
