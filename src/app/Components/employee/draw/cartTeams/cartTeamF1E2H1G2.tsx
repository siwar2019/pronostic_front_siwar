...
const CartTeamF1E2H1G2 = (props) => {
  ...
  const equipe1 =
    DrawA1 &&
    DrawA1.order.find((data) => +data.equipe_id === +draw["F1E2H1G2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw &&
        correctDraw.F1E2H1G2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.F1E2H1G2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.F1E2H1G2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
...
export default CartTeamF1E2H1G2;
