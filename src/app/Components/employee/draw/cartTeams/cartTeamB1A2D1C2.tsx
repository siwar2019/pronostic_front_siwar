  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw &&
        correctDraw.B1A2D1C2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.B1A2D1C2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.B1A2D1C2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
...
export default CartTeamB1A2D1C2;
