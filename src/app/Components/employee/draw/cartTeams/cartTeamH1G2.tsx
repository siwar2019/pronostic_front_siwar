...
const CartTeamH1G2 = (props) => {
  ...
  const equipe1 =
    DrawA1 && DrawA1.order.find((data) => +data.equipe_id === +draw["H1G2"]);
  ...
  return (
    <Grid item xs={12}>
      {user.role === "employee" &&
        ...
        correctDraw.H1G2 ? (
          <>
            {+draw[roundData[groupIndex]] === +correctDraw.H1G2 ? (
              <Card
      ...
      {user.role === "employee" &&
        (draw && correctDraw && correctDraw.H1G2 ? (
          <>
            {+draw[roundData[groupIndex]] ===
