...
import CartTeam8 from "./cartTeam8";
import CartTeamA1B2Team8 from "./cartTeams/cartTeamA1B2Team8";
import CartTeamB1A2Team8 from "./cartTeams/cartTeamB1A2Team8";
import CartTeamChampion8Team from "./cartTeams/cartTeamChampion8Team";
...
export default function DrawPronoctics8() {
  ...
  const drawSetting8Team = useAppSelector(
    ({ drawSlice: { drawSetting8Team } }) => drawSetting8Team
  );
  ...
  useEffect(() => {
    if (user.role === "employee") {
      ...
      dispatch(getDraw8TeamsSettingByEmployee(params.id as string));
    }
    if (user.role === "admin") {
      dispatch(getGroupeEquipeForAdmin(params.id as string));
      dispatch(getDrawByAdmin(params.id as string));
      dispatch(getDraw8TeamsSettingByAdmin(params.id as string));
    }
  ...
  const _onSubmit: SubmitHandler<ISettingsFormValues> = (data) => {
    if (!drawSetting8Team.event_id) {
      dispatch(createDrawSetting8Teams({ ...data, event_id: id as string }));
      setTimeout(() => {
        dispatch(getDraw8TeamsSettingByAdmin(params.id as string));
      }, 1000);
    } else {
      dispatch(updateDrawSetting8Teams({ ...data, event_id: id as string }));
      setTimeout(() => {
        dispatch(getDraw8TeamsSettingByAdmin(params.id as string));
      }, 1000);
    }
                    ...
                    >
                      <Stack>
                        ...
                        <TextField
                          ...
                          defaultValue={drawSetting8Team?.correctPhase1}
                          InputProps={{
                            inputProps: {
                      ...
                      <Stack>
                        ...
                        <TextField
                          ...
                          defaultValue={drawSetting8Team?.incorrectPhase1}
                          InputProps={{
                            inputProps: {
                              disableUnderline: false,
                              min: 0,
                    ...
                    >
                      <Stack>
                        ...
                        <TextField
                          ...
                          defaultValue={drawSetting8Team?.correctPhase2}
                          InputProps={{
                            inputProps: {
                              disableUnderline: false,
                              min: 0,
                      ...
                      <Stack>
                        ...
                        <TextField
                          ...
                          defaultValue={drawSetting8Team?.incorrectPhase2}
                          InputProps={{
                            inputProps: {
                              disableUnderline: false,
                              min: 0,
                    ...
                    >
                      <Stack>
                        ...
                        <TextField
                          ...
                          defaultValue={drawSetting8Team?.correctChampion}
                          InputProps={{
                            inputProps: {
                              disableUnderline: false,
                              min: 0,
            ...
            <>
              ...
              {user.role === "employee" && (
                ...
                >
                  ...
                  >
                    Correct : {drawSetting8TeamEmployee.correctPhase1} points
                  </div>
                  <div
                    style={{
                      verticalAlign: "middle",
              ...
              >
                {user?.role === "admin" &&
                  !employeeDraw.A1 &&
                  drawSetting8Team.correctPhase1 && (
                    <Button
                      style={{
                        background:
                          "-webkit-linear-gradient(left, #2192ff, #135799)",
              ...
              {user.role === "employee" && (
                ...
                >
                  ...
                  >
                    Correct : {drawSetting8TeamEmployee.correctPhase2} points
                  </div>
                  <div
                    style={{
                      verticalAlign: "middle",
              ...
              {user.role === "employee" && (
                ...
                >
                  ...
                  >
                    Correct : {drawSetting8TeamEmployee.correctChampion} points
                  </div>
                  <div
                    style={{
                      verticalAlign: "middle",
