...
const ModalGroupeTwo = (props) => {
  const { openModal, handleCloseModal, groupIndex, roundData, drawData } =
    props;
  ...
  // const GroupesEquipe = GroupesEquipes.filter((groupe) =>
  //   groupe.order.filter((el) => drawData.includes(el.equipe_id))
  // );
                        ...
                        label={
                          <Stack direction="row" spacing={2}>
                            <img
                              ...
                              src={(process.env.REACT_APP_UPLOADS_LOGO+ eq.equipes.images) as any}
                              alt="Country flag"
